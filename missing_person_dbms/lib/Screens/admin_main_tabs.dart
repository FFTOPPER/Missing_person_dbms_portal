...
class _AdminMainTabsState extends State<AdminMainTabs> with SingleTickerProviderStateMixin {
  int _currentIndex = 0;
  String _serverIP = "";
  ...
  void initState() {
    ...
    // Define tabs with animation placeholders
    _tabs.addAll([
      Center(child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          AnimatedIconWidget(icon: Icons.dashboard, text: "Dashboard"),
        ],
      )),
      Center(child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          AnimatedIconWidget(icon: Icons.search, text: "Manage Users"),
        ],
      )),
      Center(child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
      ...
      Center(child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          AnimatedIconWidget(icon: Icons.settings, text: "Profile"),
        ],
      )),
    ]);
  }
